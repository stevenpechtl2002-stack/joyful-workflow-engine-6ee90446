  ...
  return (
    <section className="py-32 relative overflow-hidden">
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, hsl(252 80% 60% / 0.1) 0%, transparent 60%)' }}
        animate={{ x: [100, 0, 100], y: [-100, 100, -100], scale: [1, 1.2, 1] }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-6xl font-bold mb-8">
              Warum{" "}
              <span className="text-gradient">NextGenAI</span>
              ?
            </h2>
          ...
          >
            <motion.div
              className="relative rounded-3xl p-8 border border-border/50 overflow-hidden bg-card backdrop-blur-xl"
              animate={{ y: [0, -10, 0] }}
            ...
            >
              ...
              <div
                ...
                style={{ background: 'radial-gradient(circle, hsl(252 80% 60% / 0.4) 0%, transparent 70%)' }}
              />
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="ml-auto px-3 py-1 rounded-full text-xs font-medium bg-green-500/20 text-green-600 border border-green-500/30">
                    Online
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {statsData.map((stat, index) => (
                    <motion.div
                      key={index}
                      className="rounded-2xl p-5 border border-border/30 bg-muted/50"
                      initial={{ opacity: 0, scale: 0.9 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.4, delay: index * 0.1 }}
                      whileHover={{ scale: 1.05, borderColor: 'hsl(252 80% 60% / 0.4)' }}
                    >
                      <motion.p
                        className="text-4xl font-display font-bold mb-1 text-gradient"
                      >
                ...
                {/* Activity Feed */}
                <div className="rounded-2xl p-5 border border-border/30 bg-muted/30">
                  <p className="text-xs text-muted-foreground mb-4 font-medium uppercase tracking-wider">Letzte Aktivität</p>
                  <div className="space-y-3">
                    {[{
                      text: "Reservierung aufgenommen",
                      time: "vor 2 Min."
                    }, {
                      text: "Lead qualifiziert",
                      time: "vor 5 Min."
                    }, {
