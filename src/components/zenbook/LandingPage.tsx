  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="px-6 lg:px-12 py-0 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <svg className="absolute -bottom-12 -left-12 w-56 h-56 opacity-[0.12]" viewBox="0 0 300 300"><path d="M50 280 L150 30 L280 260 Q280 290 250 290 L80 290 Q50 290 50 260Z" fill="#BE185D" /></svg>
          <svg className="absolute top-10 right-[8%] w-28 h-28 opacity-[0.13]" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#C4A35A" /></svg>
        </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <svg className="absolute -top-14 right-[20%] w-44 h-44 opacity-[0.11]" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#F43F5E" /></svg>
          <svg className="absolute bottom-4 left-[10%] w-16 h-16 opacity-[0.14]" viewBox="0 0 100 100"><polygon points="50,10 90,85 10,85" fill="#9F7AEA" /></svg>
          <svg className="absolute top-1/2 -right-8 w-72 h-36 opacity-[0.10]" viewBox="0 0 400 200"><rect x="0" y="80" width="400" height="25" rx="12" fill="#8B7355" transform="rotate(-10 200 100)" /></svg>
        </div>
      ...
      <section className="py-16 px-6 lg:px-12 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <svg className="absolute top-8 -left-8 w-40 h-40 opacity-[0.12]" viewBox="0 0 300 300"><path d="M50 280 L150 30 L280 260 Q280 290 250 290 L80 290 Q50 290 50 260Z" fill="#C4A35A" /></svg>
          <svg className="absolute -bottom-8 right-[12%] w-36 h-36 opacity-[0.11]" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#BE185D" /></svg>
        </div>
      ...
      <section className="py-24 px-6 lg:px-12 bg-muted/30 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <svg className="absolute -top-12 left-[20%] w-52 h-52 opacity-[0.03]" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#F43F5E" /></svg>
          <svg className="absolute bottom-0 right-[15%] w-64 h-32 opacity-[0.03]" viewBox="0 0 400 200"><rect x="0" y="80" width="400" height="25" rx="12" fill="#C4A35A" transform="rotate(-8 200 100)" /><rect x="0" y="130" width="300" height="18" rx="9" fill="#8B7355" transform="rotate(-8 150 130)" /></svg>
          <svg className="absolute top-1/3 -left-4 w-20 h-20 opacity-[0.05]" viewBox="0 0 100 100"><polygon points="50,10 90,85 10,85" fill="#9F7AEA" /></svg>
        </div>
