    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="lg:px-12 px-6 py-16 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <svg className="absolute -top-10 -right-10 w-48 h-48 opacity-[0.04]" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#F43F5E" /></svg>
          <svg className="absolute bottom-0 left-[15%] w-60 h-32 opacity-[0.03]" viewBox="0 0 400 200"><rect x="0" y="80" width="400" height="25" rx="12" fill="#C4A35A" transform="rotate(-10 200 100)" /></svg>
          <svg className="absolute top-1/2 right-[5%] w-20 h-20 opacity-[0.05]" viewBox="0 0 100 100"><polygon points="50,10 90,85 10,85" fill="#9F7AEA" /></svg>
        </div>
